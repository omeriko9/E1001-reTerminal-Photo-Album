...
static const char HTML_HEADER[] =
    ...
    "h1{text-align:center;color:#00d9ff;margin-bottom:30px;font-size:1.8em}"
    ".card{background:#16213e;border-radius:12px;padding:20px;margin-bottom:20px;box-shadow:0 4px 15px rgba(0,0,0,0.3)}"
    ".card h2{color:#00d9ff;margin-bottom:15px;font-size:1.2em;border-bottom:1px solid #0f3460;padding-bottom:10px}"
    ...
    ".status-item .label{font-size:0.85em;color:#888;margin-bottom:5px}"
    ".status-item .value{font-size:1.3em;font-weight:bold;color:#00d9ff}"
    ".form-group{margin-bottom:15px}"
    ".form-group label{display:block;margin-bottom:5px;color:#aaa;font-size:0.9em}"
    ".form-group input,.form-group select{width:100%;padding:12px;border:1px solid #0f3460;border-radius:6px;background:#1a1a2e;color:#eee;font-size:1em}"
    ".form-group input:focus,.form-group select:focus{outline:none;border-color:#00d9ff}"
    ".checkbox-group{display:flex;align-items:center;gap:10px}"
    ".checkbox-group input{width:auto}"
    "button{background:#00d9ff;color:#1a1a2e;border:none;padding:12px 24px;border-radius:6px;cursor:pointer;font-size:1em;font-weight:bold;transition:all 0.3s}"
    ...
    ".image-card{background:#0f3460;border-radius:8px;overflow:hidden;position:relative}"
    ".image-card .preview{height:120px;background:#1a1a2e;display:flex;align-items:center;justify-content:center;color:#666}"
    ".image-card .info{padding:10px}"
    ".image-card .name{font-size:0.85em;word-break:break-all}"
    ".image-card .size{font-size:0.75em;color:#666}"
    ".image-card .actions{padding:10px;display:flex;gap:5px}"
    ".image-card button{padding:8px 12px;font-size:0.8em}"
    ".upload-zone{border:2px dashed #0f3460;border-radius:8px;padding:40px;text-align:center;cursor:pointer;transition:all 0.3s}"
    ".upload-zone:hover,.upload-zone.drag{border-color:#00d9ff;background:rgba(0,217,255,0.1)}"
    ".upload-zone input{display:none}"
    ".progress{height:4px;background:#0f3460;border-radius:2px;margin-top:10px;overflow:hidden;display:none}"
    ".progress-bar{height:100%;background:#00d9ff;width:0;transition:width 0.3s}"
    ".toast{position:fixed;bottom:20px;right:20px;background:#00d9ff;color:#1a1a2e;padding:15px 25px;border-radius:8px;transform:translateX(150%);transition:transform 0.3s}"
...
static const char HTML_DASHBOARD_BODY[] =
    ...
    "<p style='font-size:0.8em;color:#666;margin-top:10px'>Supports: BMP, JPG, PNG (800x480 recommended)</p>"
    "</div>"
